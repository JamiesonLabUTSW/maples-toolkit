...
This reference is shared by the Rubric Maker skills. It mirrors the core schema used by the `/rubrics` web app while documenting the stricter conventions used by this Codex plugin.
...
The Codex plugin convention requires every generated or normalized rubric item to include:
