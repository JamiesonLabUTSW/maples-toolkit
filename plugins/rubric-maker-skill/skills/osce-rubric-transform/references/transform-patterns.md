...
- `Purpose`: why the item matters and what competency it evaluates.
- `Technique`: examples of observable actions or documentation evidence.
...
- Add concrete examples, accepted variations, and evaluator cues.
- Keep examples aligned with scoring criteria.
- Do not turn Technique into an exhaustive clinical textbook.
